...
class Room extends PIXI.Container{constructor(e){for(var r of(super(),this.name=e.name,this.x=x,this.y=y,e.players))this.addPlayer(r)}addPlayer(e){if(!this.players[e.id||e.name]){e.textureBlob=blobFromBytes(e.textureBlob);var r=new Player(e);return this.players[e.id||e.name]=r,this.addChild(r),r}}removePlayer(e){this.players[e].destroy({children:!0}),delete this.players[e]}movePlayer(e){this.players[e.id].moveTo(e)}}
