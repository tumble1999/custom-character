class DrawCharacterScreen{constructor(e){this.bind=createBinder(this),this.drawingSpace=new DrawSpace(640,480),window.addEventListener("touchstart",this.bind("touchStart")),window.addEventListener("touchmove",this.bind("touchMove")),window.addEventListener("touchcancel",this.bind("touchEnd")),window.addEventListener("touchend",this.bind("touchEnd")),window.addEventListener("mousedown",this.bind("mouseDown")),window.addEventListener("mouseup",this.bind("mouseUp")),window.addEventListener("mousemove",this.bind("mouseMove")),e.add(this.drawingSpace.createMesh())}destroy(){this.drawingSpace.destroy(),window.ontouchstart=window.ontouchmove=window.ontouchcancel=window.onmousedown=window.onmouseup=window.onmousemove=void 0}touchStart(e){Array(...e.touches).forEach(this.bind("mouseDown"))}touchMove(e){Array(...e.touches).forEach(this.bind("mouseMove"))}touchEnd(e){0==e.touches.length&&enableScroll(),this.drawingSpace.stopDrawing(),Array(...e.touches).forEach(this.bind("mouseUp"))}mouseDown(e){var o=screenToWorld(e.pageX,e.pageY);inside(o.toArray(),game.state.drawingSpace.canvasMesh.geometry.vertices.map(e=>e.toArray()))&&disableScroll(),this.drawingSpace.startDrawing(o.x,o.y)}mouseMove(e){var o=screenToWorld(e.pageX,e.pageY);this.drawingSpace.draw(o.x,o.y)}mouseUp(e){enableScroll();var o=screenToWorld(e.pageX,e.pageY);this.drawingSpace.stopDrawing(o.x,o.y)}async submitCharacter(){game.playerBlob=await this.drawingSpace.createBlob(),game.startGame()}}
