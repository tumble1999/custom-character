...
class World extends PIXI.Container{constructor(){super(),this.bind=createBinder(this),this.players={},this.bindSocket("joinGame"),this.bindSocket("addPlayer"),this.bindSocket("removePlayer"),this.bindSocket("movePlayer")}bindSocket(e){game.on(e,(...a)=>{console.log(e,...a),this.bind(e)(...a)})}update(e){Object.values(this.players).forEach(a=>a.update(e))}mouseDown(e){var a={x:e.pageX,y:e.pageY};game.player.moveTo(a),game.emit("movePlayer",a)}joinGame(e){for(var a of(game.playerInfo.id=e.id,e.players)){var r=this.addPlayer(a);e.id==a.id&&(game.player=r)}}addPlayer(e){if(!this.players[e.id||e.name]){e.textureBlob=blobFromBytes(e.textureBlob);var a=new Player(e);return this.players[e.id||e.name]=a,this.addChild(a),a}}removePlayer(e){this.players[e].destroy({children:!0}),delete this.players[e]}movePlayer(e){this.players[e.id].moveTo(e)}}
